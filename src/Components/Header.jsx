...
function Header() {
  ...
  const menuList = [
    {
      id: 1,
      title:<a href="#sectionh" className='text-orange-500 font-normal hover:text-white'>HOME</a> 
    },
    {
      id: 2,
      title: <a href="#sectionp" className='text-orange-500 font-normal hover:text-white'>TRENDS</a>
    },
    {
      id: 3,
      title: <a href="#sectiona" className='text-orange-500 font-normal hover:text-white'>ABOUT</a>
    },
